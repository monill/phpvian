                        ...
                        <div class="install-item">
                            ...
                            <div class="box-item">
                                <div class="item table-area">
                                    <table class="requirment-table">
                                        ...
                                        if ($htaccess == true) {
                                            ...
                                            $error = $error+1;
                                            tableRow('.htaccess',' Required ".htaccess" not available',0);
                                        }
                                        ?>
                                    </table>
                                </div>
                                <div class="item text-right">
                                    <?php
                                    if ($error == 0) {
                                        echo '<a class="theme-button choto" href="/installer/database">Next Step <i class="fa fa-angle-double-right"></i></a>';
                                    } else {
                                        echo '<a class="theme-button btn-warning choto" href="/installer/files">ReCheck <i class="fa fa-sync-alt"></i></a>';
                                    }
                                    ?>
                                </div>
                            </div>
