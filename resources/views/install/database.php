                ...
                <div class="installation-wrapper">
                    <div class="install-content-area">
                        <div class="install-item">
                            ...
                            <div class="box-item">
                                <form action="/installer/database" method="post" class="information-form-area mb--20">
                                    <div class="info-item">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="information-form-group col-sm-6">
                                                <input type="text" name="db_port" placeholder="Database Port" value="3306" required>
                                            </div>
                                            <div class="information-form-group col-sm-6">
